                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                 ...
                                 <div class="form-group form-primary position-relative">
                                    ...
                                    <input type="password" id="password" name="password" class="form-control password" required="" placeholder="Password" style="padding-right: 40px;">
                                     <span class="form-bar">
                                     </span>
                                    <!-- Eye icon inside the input -->
                                    <i class="fa fa-eye toggle-password" style="position:absolute; top:50%; right:10px; transform:translateY(-50%); cursor:pointer; color:#666;"></i>
                                </div>
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            <div class="forgot-phone text-right f-right">
                                                <a href="forgotpassword.php" class="text-right f-w-600"> Forgot Password?</a>
                                            </div>
                                        </div>
                                    </div>
