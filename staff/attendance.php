                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                           ...
                                           <div class="btn-group" role="group" aria-label="View selector">
                                                ...
                                                <a href="attendance.php?view=all" class="btn btn-primary <?php echo $viewType === 'all' ? 'active' : ''; ?>">All Records</a>
                                                <a href="attendance.php?view=weekly" class="btn btn-primary <?php echo $viewType === 'weekly' ? 'active' : ''; ?>">Weekly Hours</a>
                                                <a href="attendance.php?view=daysoff" class="btn btn-primary <?php echo $viewType === 'daysoff' ? 'active' : ''; ?>">Days Off Accumulated</a>
                                                <a href="attendance.php?view=detailed" class="btn btn-primary <?php echo $viewType === 'detailed' ? 'active' : ''; ?>">Detailed Breakdown</a>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <!-- contact data table card start -->
                                                                     <?php
                                                                        ...
                                                                        mysqli_stmt_bind_param($stmt, "s", $session_sstaff_id);
