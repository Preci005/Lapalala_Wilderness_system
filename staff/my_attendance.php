                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <!-- contact data table card start -->
                                                                     <?php
                                                                        // Query to fetch attendance records including late_minutes
                                                                        $session_sstaff_id = $_SESSION['sstaff_id'];
                                                                        $stmt = mysqli_prepare($conn, "
    SELECT a.date, a.staff_id, e.first_name, e.middle_name, e.last_name,
        a.total_hours, a.time_in, a.time_out, a.late_minutes, a.recorded_hours, a.attendance_status
                                                                                        ...
                                                                                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                                                                            <?php
                                                                                                ...
                                                                                                if ($row['recorded_hours'] !== null) {
                                                                                                    // Use recorded hours if available (e.g., Friday early clock-out)
                                                                                                ...
                                                                                                // Format late time
                                                                                                $late_display = formatLateTimeDisplay($row['late_minutes']);
